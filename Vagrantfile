...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder "/home/balmas/workspace/arethusa-example-data", "/arethusa-example-data"
  config.vm.synced_folder "/home/balmas/workspace/arethusa-configs", "/arethusa-configs"
